...
public abstract class SkippingMazeSolver extends MazeSolver {
	...
	/**
	 * Follows a path until a choice point. Returns the choice encountered. /* If a
	 * deadend is encountered, returns a Choice object whose 'at' field is the
	 * location of the dead end and whose 'choices' list is empty.
	 * 
