...
public class Maze implements Serializable {
	 ...
	 * AtomicIntegerArray. The upper-left, or north-western corner of the maze is
	 * given by maze.get(0). The lower-right, or south-eastern corner of the maze is
	 * maze.get(maze.length()-1). The maze is stored in row-major order, so the
	 * element at row n, column m is given by maze.get(n * width + m).
	 * </p>
	 * 
	 * <p>
	 * The entrance to the maze is at row: 0, column: width/2. The exit is at row:
	 * height-1, column: width/2.
	 * </p>
	 * 
	 * <p>
	 * Individual bits of each byte in the "maze" array are used to encode
	 * information about that cell of the maze. Only the low-order 8 bits are used.
	 * The designated bits are:
	 * </p>
	 * 
	 * <pre>
	 * CCSSEEse
	 ...
	 * </pre>
	 * 
	 * <dd>marks two bits that are used to give a color to this cell in the maze.
	 * Each of the four bit combinations corresponds to a different color that will
	 * be used by the MazeDisplay object when drawing this cell. This can be used by
	 * your code to provide visual feedback on solving progress or for debugging.
	 * <dt>
	 * 
	 * <pre>
	 * SS
	 * </pre>
	 * 
	 * <dd>marks two bits that are used to give a color to the southern side of this
	 * cell.
	 * <dt>
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * 
	 * <dd>marks two bits that are used to give a color to the eastern side of this
	 * cell.
	 * <dt>
	 * 
	 * <pre>
	 ...
	 * 
	 * <p>
	 * There is always a wall to the south of cells on the southern border of the
	 * maze. There is always a wall to the east of cells on the eastern border of
	 * the maze. There is an implicit wall to the north of cells on the northern
	 * border and to the west of cells on the western border.
	 * </p>
	 */
	...
	// Position variables used internally. Allocated once here to avoid excessive
	// memory allocation.
	private static final long serialVersionUID = 1L;

	/**
	 * Returns the integer at the given position. The returned value uses the
	 * encoding described in the documentation for the {@link Maze#maze maze} field.
	 */
	...
	/**
	 * Returns the list of open directions at this position. A direction is open if
	 ...
	 * specified value, which must be between 0 and 3 inclusive. The northern wall
	 * of top-row cells and the western wall of left-column cells cannot be colored.
	 */
	 ...
	 * colored. The color 0 will be returned for these cases.
	 */
